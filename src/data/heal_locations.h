static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_OUTSET_SPRINGS_OUTSIDE - 1] = {MAP_GROUP(OUTSET_SPRINGS_OUTSIDE), MAP_NUM(OUTSET_SPRINGS_OUTSIDE), -3, 0},
    [HEAL_LOCATION_ROUTE1 - 1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), 6, 13},
    [HEAL_LOCATION_NEW_MAP1 - 1] = {MAP_GROUP(NEW_MAP1), MAP_NUM(NEW_MAP1), 18, 8},
    [HEAL_LOCATION_NEW_MAP2 - 1] = {MAP_GROUP(NEW_MAP2), MAP_NUM(NEW_MAP2), 25, 11},
};
